...
fixtures.forEach((fixture, idx) => {
  describe(`sync test: ${fixture.name}`, function () {
    beforeEach(async () => {
    ...
    it(
      ...
      async () => {
        ...
        await startNeuronWithConfig({
          ...
          userDataPath: `${fixture.tmpPath}/neuron-user-data-${process.pid}-full`,
        })
        await startCkbMiner({
          binPath: CKB_CONFIG.binPath,
          decPath: `${fixture.tmpPath}/ckb`,
        ...
        await waitNeuronDatabaseSettled(`full-${CKB_CONFIG.genesisHash}.sqlite`, fixture.compareFullNodeSqlitePath)
        await stopNeuron()
    ...
    it(
      ...
      async () => {
        await startNeuronWithConfig({
          ...
          userDataPath: `${fixture.tmpPath}/neuron-user-data-${process.pid}-light`,
        })
        await scheduler.wait(15 * 1000)
        await startCkbMiner({
          binPath: CKB_CONFIG.binPath,
          decPath: `${fixture.tmpPath}/ckb`,
        })
        await waitNeuronSyncSuccess(60 * 60)
        await waitNeuronDatabaseSettled(`light-${CKB_CONFIG.genesisHash}.sqlite`, fixture.compareLightNodeSqlitePath)
        await stopNeuron()
