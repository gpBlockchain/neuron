...
import { cleanLightCkbNode, startCkbLightNodeWithConfig, stopLightCkbNode } from '../services/light-runner-wasm'
import {
  backupNeuronCells,
    ...
    it(
      ...
      async () => {
        await startNeuronWithConfig({
          ...
          userDataPath: `${fixture.tmpPath}/neuron-user-data-${process.pid}-wasm-light`,
        })
